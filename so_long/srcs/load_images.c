...
/*   Updated: 2024/12/16 13:53:22 by msalim           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_images	*init_images_textures(void *mlx, t_game *game)
{
	...
	images->height = 64;
	images->width = 64;
	images->wall = mlx_xpm_file_to_image(mlx, "./textures/wall64.xpm",
	...
	images->player = mlx_xpm_file_to_image(mlx, "./textures/player.xpm",
			&images->width, &images->height);
	images->collectible = mlx_xpm_file_to_image(mlx, "./textures/diamond.xpm",
			&images->width, &images->height);
	return (images);
}
